...
export const COVERAGE_BASELINE: Record<string, BaselineEntry> = {
  ...
  "jacksonville":     { neighborhoodCount:  35, source: "JSO NIBRS Incidents — Jacksonville Sheriff's Office (ArcGIS) — ZIP-level" },
  ...
  "gainesville":      { neighborhoodCount:  12, source: "GPD Crime Responses (data.cityofgainesville.org, Socrata) — GPD patrol zones" },
  // Midwest
