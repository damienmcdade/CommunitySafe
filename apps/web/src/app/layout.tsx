...
export const metadata: Metadata = {
  ...
  description:
    "Neighborhood-level safety awareness across 45 US cities and counties. Drawn from " +
  ...
  twitter: {
    ...
    title: "CommunitySafe",
    description:
      "Neighborhood-level safety awareness across 45 US cities and counties. Drawn from official police open-data feeds.",
  },
