  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>TravelSafe is a neighborhood-level safety-awareness tool that surfaces publicly published police-incident data for 37 supported US cities, compared to the FBI Crime in the Nation national average. It is informational and educational.</p>
      </section>
