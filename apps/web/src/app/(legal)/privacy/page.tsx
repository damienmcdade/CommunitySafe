    ...
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Browsing the map / safety scores / community feed does NOT require an account. Account-required features are explicitly labeled (Personal Safety, TravelSafe posts).</li>
        </ul>
      </section>
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>The Personal Safety and TravelSafe features require an account. When you register we store, in our database:</p>
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Your TravelSafe post bodies, comments, and reports — and an append-only edit log if you revise a post.</li>
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>We do not sell, license, or share user-account data with third parties for advertising or marketing. TravelSafe accounts, contacts, check-in timers, and posts are never transmitted to ad networks. AdSense&apos;s collection is limited to what the browser sends directly to Google when an ad slot loads (described in the <strong>Advertising</strong> section below).</p>
      </section>

      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        <h2 className="font-display text-xl text-slate2-900">Advertising</h2>
        <p>TravelSafe displays ads served by <strong>Google AdSense</strong> (publisher <code className="text-xs">ca-pub-8731629548430880</code>) to cover hosting costs. AdSense is a Google product; its data practices are governed by{" "}
        ...
        <p>What TravelSafe sends to AdSense:</p>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>California Civil Code §1798.135 requires every business that &quot;sells&quot; or &quot;shares&quot; personal information to surface a clear opt-out link. TravelSafe does not sell or share personal information for cross-context behavioral advertising, monetary consideration, or any equivalent benefit. There is consequently no opt-out flow to surface — but for transparency we still affirm the position here:</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>We have not sold or shared personal information in the preceding 12 months.</li>
          <li>We have no contractual relationship that would permit a third party to sell or share TravelSafe-collected personal information on our behalf.</li>
        ...
        <p>California residents can also exercise the right to limit the use of sensitive personal information; TravelSafe does not process the categories California enumerates as sensitive (precise location is treated as personal — see Geolocation in the section above — and is only retained for the duration of an active Check-In or Live Share session you arm yourself).</p>
      </section>
