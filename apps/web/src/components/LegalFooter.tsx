...
/// gives every legal surface the same operator disclosure (Cyberwave Global),
...
export function LegalFooter() {
  return (
    <footer className="mt-8 border-t border-sand-200 pt-4 text-center text-xs text-slate2-500 space-y-2">
      ...
      <p>
        © {new Date().getFullYear()} Cyberwave Global — operator of CommunitySafe. All rights reserved.{" "}
